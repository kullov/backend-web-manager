...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 27, 2020 at 06:10 AM
...
CREATE TABLE IF NOT EXISTS `intern_profile` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
(93, '87656591', 'Agneta', 'McCarry', '1999-04-09', '2017-01-15', 'K64A0', 'https://robohash.org/recusandaeconsequaturid.bmp?size=50x50&set=set1', 'Pu99460xuKEk', 'amccarry2k@ask.com', '244-434-1349', '𠜎𠜱𠝹𠱓𠱸𠲖𠳏', NULL),
...
CREATE TABLE IF NOT EXISTS `request` (
  ...
  KEY `status_2` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=127 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
CREATE TABLE IF NOT EXISTS `request_assignment` (
  ...
  KEY `intern_id` (`intern_id`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
